...
|------|--------------|-----------|--------|--------|---------------|
| 1 | **얼굴 미검출 처리** | 중앙 크롭 | 🔴 **HIGH** | **+3~4%** | 유지 ✅ |
| 2 | **집계 방식 (Mean/Max)** | 0.6/0.4 | 🔴 **HIGH** | **+2~3%** | 0.7/0.3 시도 |
| 3 | **프레임 필터링** | 검출 성공만 | 🟡 MEDIUM | **+1~2%** | 유지 또는 가중치 조정 |
| 4 | **프레임 수** | 30 | 🟡 MEDIUM | ? | 35~40 증가 시도 |
| 5 | **Margin (박스 여유)** | 1.3 | 🟢 LOW | ? | 1.4~1.5 시도 |
