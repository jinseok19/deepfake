...
| EXP-003 | 10.29 | ViT-base+TTA | **에러** | - | - | ❌ 실패 | 메모리 OOM |
| **EXP-003-Fixed** | 10.29 | ViT-base+TTA | **0.5600** | **+2.01%** ✅ | - | 🏆 최고 | [📄](EXP-003-Fixed.md) |
| EXP-004 | 10.29 | ViT+FF++ | **준비중** | ? | - | 🎯 대기 | [📄](EXP-004.md) Val: 0.9933 |
...
**마지막 업데이트**: 2025.10.29  
**총 실험 횟수**: 5회 (EXP-003-Fixed 완료)  
**남은 일일 제출**: 1회  
**현재 최고**: 0.5600 (EXP-003-Fixed)  
**다음 계획**: EXP-004 파인튜닝 모델 제출 검토
